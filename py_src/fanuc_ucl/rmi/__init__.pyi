...
class RmiDriver:
    ...
    @overload
    def send(self, packet: FrcCircularMotion) -> RmiHandle[FrcCircularMotionResponse]: ...
    @overload
    def send(self, packet: FrcCircularRelative) -> RmiHandle[FrcCircularRelativeResponse]: ...
    @overload
    ...
    @overload
    def send(self, packet: FrcGetUFrameUTool) -> RmiHandle[FrcGetUFrameUToolResponse]: ...
    @overload
    ...
    @overload
    def send(self, packet: FrcJointMotionJRep) -> RmiHandle[FrcJointMotionJRepResponse]: ...
    @overload
    def send(self, packet: FrcJointRelative) -> RmiHandle[FrcJointRelativeResponse]: ...
    @overload
    def send(self, packet: FrcJointRelativeJRep) -> RmiHandle[FrcJointRelativeJRepResponse]: ...
    @overload
    def send(self, packet: FrcLinearMotion) -> RmiHandle[FrcLinearMotionResponse]: ...
    @overload
    def send(self, packet: FrcLinearMotionJRep) -> RmiHandle[FrcLinearMotionJRepResponse]: ...
    @overload
    def send(self, packet: FrcLinearRelative) -> RmiHandle[FrcLinearRelativeResponse]: ...
    @overload
    def send(self, packet: FrcLinearRelativeJRep) -> RmiHandle[FrcLinearRelativeJRepResponse]: ...
    @overload
    def send(self, packet: FrcPause) -> RmiHandle[FrcPauseResponse]: ...
    @overload
    def send(self, packet: FrcReadCartesianPosition) -> RmiHandle[FrcReadCartesianPositionResponse]: ...
    @overload
    ...
    @overload
    def send(self, packet: FrcReadJointAngles) -> RmiHandle[FrcReadJointAnglesResponse]: ...
    @overload
    def send(self, packet: FrcReadPositionRegister) -> RmiHandle[FrcReadPositionRegisterResponse]: ...
    @overload
    def send(self, packet: FrcReadTCPSpeed) -> RmiHandle[FrcReadTCPSpeedResponse]: ...
    @overload
    def send(self, packet: FrcReadUFrameData) -> RmiHandle[FrcReadUFrameDataResponse]: ...
    @overload
    ...
    @overload
    def send(self, packet: FrcSetUFrameUTool) -> RmiHandle[FrcSetUFrameUToolResponse]: ...
    @overload
    ...
    @overload
    def send(self, packet: FrcWritePositionRegister) -> RmiHandle[FrcWritePositionRegisterResponse]: ...
    @overload
    def send(self, packet: FrcWriteUFrameData) -> RmiHandle[FrcWriteUFrameDataResponse]: ...
    @overload
    def send(self, packet: FrcWriteUToolData) -> RmiHandle[FrcWriteUToolDataResponse]: ...
